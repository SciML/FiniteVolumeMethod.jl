...
function parallel_fvm_eqs!(du, u, p, t)
    ...
    get_parallel_triangle_contributions!(
        _duplicated_du, u, prob, t, chunked_solid_triangles, solid_triangles)
    get_parallel_boundary_edge_contributions!(
        _duplicated_du, u, prob, t, chunked_boundary_edges, boundary_edges)
