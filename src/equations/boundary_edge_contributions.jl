...
@inline function _get_boundary_flux(
        prob::AbstractFVMProblem, x, y, t, α, β, γ, nx, ny, i, j, u::T) where {T}
...
@inline function _get_boundary_flux(
        prob::FVMSystem, x, y, t, nx, ny, i, j, ℓ, u::T, var, flux) where {T}
...
@inline function _get_boundary_fluxes(
        prob::FVMSystem, x, y, t, α, β, γ, nx, ny, i, j, u::T, ℓ) where {T}
...
@inline function get_boundary_fluxes(
        prob::AbstractFVMProblem, α::T, β, γ, i, j, t) where {T}
